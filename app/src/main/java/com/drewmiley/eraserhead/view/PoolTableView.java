...
public class PoolTableView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mExampleString = a.getString(
                R.styleable.PoolTableView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.PoolTableView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.PoolTableView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.PoolTableView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.PoolTableView_exampleDrawable);
